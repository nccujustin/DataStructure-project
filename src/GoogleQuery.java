...

	{
		...
		for(Element li : lis)
		{
...

			{
				...
				//lrcbox
				if (url.indexOf("youtube.com")==-1 && url.indexOf(".pdf")==-1 && url.indexOf(".doc")==-1 && url.indexOf(".txt")==-1 && url.indexOf("weibo")==-1 && url.indexOf("apple.com")==-1&&url.indexOf("wikipedia")==-1) {
